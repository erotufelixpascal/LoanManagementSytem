    ...
    if request.user.is_authenticated:
        ...
        if request.method =='POST':
            ...
            if form.is_valid():
                ...
                return render(request, 'ManagerApp/templates/ManagerApp/adminLogin.html', context={'form':form,'error':"Invalid username or password"})
    return render (request, 'ManagerApp/templates/ManagerApp/adminLogin.html', context={'form':form, 'user': "Admin Login"})
...
def dashboard(request):
    ...
    return render(request, 'ManagerApp/templates/ManagerApp/dashboard.html', context= dict)
...
def add_category(request):
    ...
    return render(request, 'ManagerApp/templates/ManagerApp/admin_add_category.html', {'form': form})

@staff_member_required(login_url='/manager/admin-login')
def total_users(request):
    users = CustomerSignUp.objects.all()

    return render(request, 'ManagerApp/templates/ManagerApp/customer.html', context={'user':users})
...
def loan_request(request):
    ...
    return render(request, 'ManagerApp/templates/ManagerApp/request_user.html', context={'loanrequest': loanrequest})
...
def approved_loan(request):
    ...
    return render(request, 'ManagerApp/templates/ManagerApp/approved_loan.html', context={'approvedLoan': approvedLoan})


@staff_member_required(login_url='/manager/admin-login')
def rejected_loan(request):
    rejectedLoan = loanRequest.objects.filter(status='rejected')
    return render(request, 'ManagerApp/templates/ManagerApp/rejected_loan.html', context={'rejectedLoan': rejectedLoan})


@staff_member_required(login_url='/manager/admin-login')
def transaction_loan(request):
    transactions = loanTransaction.objects.all()
    return render(request, 'ManagerApp/templates/ManagerApp/transaction.html', context={'transactions': transactions})
